    ...
    if (email) {
      ...
      if (userId) {
        ...
        if (isPurchase) {
          ...
          const isAnual = combinedStr.includes('anual') || combinedStr.includes('year') || combinedStr.includes('ano');
          const cycle = isAnual ? 'anual' : 'mensal';
          
          let tier = 'basica';
          if (combinedStr.includes('pro')) tier = 'pro';
          else if (combinedStr.includes('top')) tier = 'top';

          newPlan = `${tier}_${cycle}`;
        }
